...
int main() {
    ...
    brl::ViewportContext viewport1 = brl::createViewportContext(&renderContext, "viewport1");
    brl::ViewportContext viewport2 = brl::createViewportContext(&renderContext, "viewport2");
    ...
    brl::InstanceData* data = new brl::InstanceData[50000];
    ...
    while (!brl::windowShouldClose(window)) {
        ...
        brl::beginRender(window);
            ...
            brl::beginViewport(viewport1, camera1);
                ...
                for (int i = 0; i < 50000; i++) {
                    brl::drawPlaneInstanced(renderContext, data[i].transform);
                }
